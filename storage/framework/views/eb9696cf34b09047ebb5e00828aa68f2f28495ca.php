...
<nav class="navbar navbar-expand-lg navbar-transparent navbar-absolute fixed-top ">
  <div class="container-fluid">
    <div class="navbar-wrapper">
      <a class="navbar-brand" href="<?php echo e(url('/')); ?>">Trang Chủ Sản Phẩm</a>
    </div>
      ...
      <ul class="navbar-nav">
        ...
        <li class="nav-item dropdown">
          ...
          <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdownProfile">
            <a class="dropdown-item" href="<?php echo e(route('product.create')); ?>"><?php echo e(__('Profile')); ?></a>
...
<?php /**PATH C:\wamp64\www\backend2shop\resources\views/layouts/navbars/navs/auth.blade.php ENDPATH**/ ?>