<?php if($paginator->hasPages()): ?>
    <ul class="pagination" role="navigation">
        ...
        <?php else: ?>
            <li class="page-item">
                <a class="page-link" href="<?php echo e($paginator->url(1)); ?>" rel="prev" aria-label="<?php echo app('translator')->getFromJson('pagination.previous'); ?>">First</a>
            </li>
        <?php endif; ?>
        ...
        <?php if($paginator->hasMorePages()): ?>
            <li class="page-item">
                <a class="page-link" href="<?php echo e($paginator->url($paginator->lastPage())); ?>" rel="next" aria-label="<?php echo app('translator')->getFromJson('pagination.next'); ?>">Last</a>
            </li>
        <?php else: ?>
            <li class="page-item disabled" aria-disabled="true" aria-label="<?php echo app('translator')->getFromJson('pagination.next'); ?>">
...
<?php endif; ?>
<?php /**PATH C:\wamp64\www\backend2shop\resources\views/vendor/pagination/bootstrap-4.blade.php ENDPATH**/ ?>